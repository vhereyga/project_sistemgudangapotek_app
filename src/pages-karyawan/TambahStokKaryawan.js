...
import './TStokKaryawan.css'

const TambahStokKaryawan = () => {
    ...
    return (
        <div className="stock-container">
            ...
            {/* Home Button */}
            <div className="home-button"><i className="fas fa-home"></i></div>
...
export default TambahStokKaryawan;
