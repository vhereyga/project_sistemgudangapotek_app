...
import './ObatKaryawan.css'

function EditObatKaryawan() {
    ...
    const simpanData = () => {
        ...
        navigate('/DaftarStokKaryawan'); // Adjust the path to the stock list page as needed
...
export default EditObatKaryawan;
